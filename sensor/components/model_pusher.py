...
from sensor.entity.artifact_entity import ModelTrainerArtifact,DataValidationArtifact,ModelEvaluationArtifact, DataTransformationArtifact, ModelPusherArtifact
